...
public class Radar : MonoBehaviour
{
    ...
    //Cuando aparece un ítem en el juego
    public void ItemDropped(GameObject go)
    {
        //Debug.Log("Item Dropped");
        //Para cada objeto del radar que vamos a añadir, buscamos dentro del script su icono
        RegisterRadarObject(go, go.GetComponent<Item>().icon);
    }

    //Cuando interactuamos como jugadores con un objeto
    public void ItemPickedUp(GameObject go)
    {
        //Borra ese objeto del radar
